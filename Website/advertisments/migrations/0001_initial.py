    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ad_title', models.CharField(default='Not Mentioned', max_length=200)),
                ...
                ('ad_image1', models.ImageField(blank=True, default='No Image', upload_to='ad_images/')),
                ('ad_image2', models.ImageField(blank=True, default='No Image', upload_to='ad_images/')),
                ('ad_image3', models.ImageField(blank=True, default='No Image', upload_to='ad_images/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('post_date_review', models.DateTimeField(default='')),
                ('review_of_ad', models.ForeignKey(default=' ', on_delete=django.db.models.deletion.CASCADE, to='advertisments.Ad')),
            ],
        ),
        migrations.CreateModel(
            name='Profile',
            fields=[
                ...
                ('ad_profile_pic', models.ImageField(blank=True, default='No Image', upload_to='profile_images/')),
