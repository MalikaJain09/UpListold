...
class Profile(models.Model):
    ...
    ad_profile_pic = models.ImageField(upload_to='profile_images/',default='No Image' , blank=True)

    def __str__(self):
        return '{} Profile'.format(self.user_name)
...
class Ad(models.Model):
    ...
    ad_title = models.CharField(max_length=200 , default='Not Mentioned')
    ...
    ad_description = models.CharField(max_length=200, default='Not Mentioned')
    ad_image1 = models.ImageField(upload_to='ad_images/', default='No Image', blank=True)
    ad_image2 = models.ImageField(upload_to='ad_images/', default='No Image' , blank=True)
    ad_image3 = models.ImageField(upload_to='ad_images/', default='No Image' , blank=True)
    ad_status = models.BooleanField(default=True)
    post_date = models.DateTimeField(default='')
    ad_location = models.CharField(max_length=200, default='Not Mentioned')
...
class Review(models.Model):
    ...
    ad_message = models.CharField(max_length=500, default='None')
